...
@section('content')
    <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="type_post" id="type_post" value="insurance-products">
        <div class="row">
            <div class="col-md-9">
                <div class="card mb-3">
                        ...
                        <div class="tab-pane fade show active" id="content-id" role="tabpanel"
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <select id="post_category" name="post_category" class="form-select">
                                ...
                                <div class="col-md-12">
                                    <label class="form-label" for="title_product_id">Title (ID)</label>
                                    <input type="text" id="title_product_id" name="title_post_id" class="form-control"
                                        placeholder="Title (ID)">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label" for="slug_product_id">Slug (ID)</label>
                                    <input type="text" id="slug_product_id" name="slug_post_id" class="form-control"
                                        placeholder="Slug Url (ID)">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label" for="subtitle_id">Subtitle (ID)</label>
                                    <input type="text" id="subtitle_id" name="subtitle_id" class="form-control"
                                        placeholder="Subtitle (ID)">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label" for="content_product_id">Content (ID)</label>
                                    <textarea class="ckeditor" name="content_id" id="content_product_id" cols="30" rows="10"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="content-en" role="tabpanel" aria-labelledby="content-en-tab">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <select id="post_category_en" name="post_category_en" class="form-select">
                                ...
                                <div class="col-md-12">
                                    <label class="form-label" for="title_product_en">Title (EN)</label>
                                    <input type="text" id="title_product_en" name="title_post_en" class="form-control"
                                        placeholder="Title (EN)">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label" for="slug_product_en">Slug (EN)</label>
                                    <input type="text" id="slug_product_en" name="slug_post_en" class="form-control"
                                        placeholder="Slug Url (EN)">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label" for="subtitle_en">Subtitle (EN)</label>
                                    <input type="text" id="subtitle_en" name="subtitle_en" class="form-control"
                                        placeholder="Subtitle (ID)">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label" for="content_product_en">Content (EN)</label>
                                    <textarea class="ckeditor" name="content_en" id="content_product_en" cols="30" rows="10"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script defer>
        document.addEventListener('DOMContentLoaded', function() {
            const titleIdInput = document.getElementById('title_product_id');
            const titleEnInput = document.getElementById('title_product_en');
            const slugIdInput = document.getElementById('slug_product_id');
            const slugEnInput = document.getElementById('slug_product_en');
