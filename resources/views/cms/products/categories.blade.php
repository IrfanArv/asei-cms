@extends('layouts.cms')
@section('title', 'Insurance Categories')
@section('content')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('insurance.categories.data') }}",
                ...
                buttons: [

                    {
                        ...
                        className: 'btn btn-primary create-category-insurance',
                    }
                ],

            });
            $('div.head-label').html('<h5 class="card-title mb-0">Insurance Categories</h5>');

            $('body').on('click', '.create-category-insurance', function() {
                $('#titles-modal').html('Create Category Insurance');
